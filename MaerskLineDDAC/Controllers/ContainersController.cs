...
namespace MaerskLineDDAC.Controllers
{
    ...
    public class ContainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContainerID,Description,DetailedDescription,AmountOfContainers,TotalWeight")] Container container)
        {
        ...
        public ActionResult Edit([Bind(Include = "ContainerID,Description,DetailedDescription,AmountOfContainers,TotalWeight")] Container container)
        {
            if (ModelState.IsValid)
            {
